package com.oakiha.audiobookplayer.di
...
import com.oakiha.audiobookplayer.AudioBookApp
import com.oakiha.audiobookplayer.data.database.AlbumArtThemeDao
import com.oakiha.audiobookplayer.data.database.EngagementDao
import com.oakiha.audiobookplayer.data.database.FavoritesDao
import com.oakiha.audiobookplayer.data.database.LyricsDao
import com.oakiha.audiobookplayer.data.database.MusicDao
import com.oakiha.audiobookplayer.data.database.AudioBookDatabase
import com.oakiha.audiobookplayer.data.database.SearchHistoryDao
import com.oakiha.audiobookplayer.data.database.TransitionDao
import com.oakiha.audiobookplayer.data.preferences.UserPreferencesRepository
import com.oakiha.audiobookplayer.data.preferences.dataStore
import com.oakiha.audiobookplayer.data.media.SongMetadataEditor
import com.oakiha.audiobookplayer.data.network.deezer.DeezerApiService
import com.oakiha.audiobookplayer.data.network.lyrics.LrcLibApiService
import com.oakiha.audiobookplayer.data.repository.ArtistImageRepository
import com.oakiha.audiobookplayer.data.repository.LyricsRepository
import com.oakiha.audiobookplayer.data.repository.LyricsRepositoryImpl
import com.oakiha.audiobookplayer.data.repository.MusicRepository
import com.oakiha.audiobookplayer.data.repository.MusicRepositoryImpl
import com.oakiha.audiobookplayer.data.repository.TransitionRepository
import com.oakiha.audiobookplayer.data.repository.TransitionRepositoryImpl
...
object AppModule {
    ...
    fun provideSongRepository(
        @ApplicationContext context: Context,
        mediaStoreObserver: com.oakiha.audiobookplayer.data.observer.MediaStoreObserver,
        favoritesDao: FavoritesDao,
        userPreferencesRepository: UserPreferencesRepository
    ): com.oakiha.audiobookplayer.data.repository.SongRepository {
        return com.oakiha.audiobookplayer.data.repository.MediaStoreSongRepository(
            context = context,
    ...
    fun provideMusicRepository(
        ...
        songRepository: com.oakiha.audiobookplayer.data.repository.SongRepository,
        favoritesDao: FavoritesDao
    ): MusicRepository {

...
import com.oakiha.audiobookplayer.data.repository.NoLyricsFoundException
...
class LyricsStateHolder @Inject constructor(
    ...
    fun initialize(
        ...
        stablePlayerState: StateFlow<com.oakiha.audiobookplayer.presentation.viewmodel.StablePlayerState>
    ) {
    ...
    fun importLyricsFromFile(songId: Long, lyricsContent: String, currentSong: Song?) {
        scope?.launch {
            ...
            if (currentSong != null && currentSong.id.toLong() == songId) {
                ...
                // Actually Utils are usually objects. Accessing com.oakiha.audiobookplayer.utils.LyricsUtils
                ...
                // It was in `com.oakiha.audiobookplayer.utils.LyricsUtils`.
            } else {

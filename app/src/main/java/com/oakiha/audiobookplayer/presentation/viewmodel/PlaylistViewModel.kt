...
import com.oakiha.audiobookplayer.data.playlist.M3uManager
...
class PlaylistViewModel @Inject constructor(
    ...
    private fun findFolder(
        targetPath: String,
        folders: List<com.oakiha.audiobookplayer.data.model.MusicFolder>
    ): com.oakiha.audiobookplayer.data.model.MusicFolder? {
        val queue: ArrayDeque<com.oakiha.audiobookplayer.data.model.MusicFolder> = ArrayDeque(folders)
    ...
    private fun com.oakiha.audiobookplayer.data.model.MusicFolder.collectAllSongs(): List<Song> {

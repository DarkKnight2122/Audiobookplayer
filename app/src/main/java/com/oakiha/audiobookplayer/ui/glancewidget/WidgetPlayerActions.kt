...
object WidgetPlayerActions {
    const val PLAY_PAUSE = "com.oakiha.audiobookplayer.PLAY_PAUSE"
    const val NEXT = "com.oakiha.audiobookplayer.NEXT"
    const val PREVIOUS = "com.oakiha.audiobookplayer.PREVIOUS"
